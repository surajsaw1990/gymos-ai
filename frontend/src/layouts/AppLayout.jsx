...
export default function AppLayout() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-[1440px] gap-4 px-4 py-4 sm:px-6 lg:px-8">
        <AppSidebar />

        <div className="flex min-w-0 flex-1 flex-col gap-4 pb-24 lg:pb-4">
          <motion.header
            className="panel-surface premium-border ambient-frame px-5 py-4 sm:px-6"
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-4 md:gap-5">
                  <Badge icon="pulse">Recovery synced</Badge>
